"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.extractRSCContent = extractRSCContent; /**
  ...
  function extractTable(tableNode) {
    ...
    function walkTable(node, isHeader = false) {
      ...
      if (node[0] === "$") {
        ...
        if (tag === "thead") walkTable(nodeProps.children, true);else
        if (tag === "tbody") walkTable(nodeProps.children, false);else
        if (tag === "tr") {
          const cells = [];
