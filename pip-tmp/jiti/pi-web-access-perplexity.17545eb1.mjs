"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.isPerplexityAvailable = isPerplexityAvailable;exports.searchWithPerplexity = searchWithPerplexity;var _nodeFs = await jitiImport("node:fs");
...
function loadConfig() {
  ...
  const content = (0, _nodeFs.readFileSync)(CONFIG_PATH, "utf-8");
  try {
...
async function searchWithPerplexity(query, options = {}) {
  ...
  _activity.activityMonitor.updateRateLimit({
