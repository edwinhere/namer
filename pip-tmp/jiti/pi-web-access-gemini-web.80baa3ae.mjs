"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getActiveGoogleEmail = getActiveGoogleEmail;exports.isGeminiWebAvailable = isGeminiWebAvailable;exports.queryWithCookies = queryWithCookies;var _nodePath = await jitiImport("node:path");
var _chromeCookies = await jitiImport("./chrome-cookies.js");
var _geminiWebConfig = await jitiImport("./gemini-web-config.ts");
...
async function isGeminiWebAvailable(chromeProfile) {
  if (!(0, _geminiWebConfig.isBrowserCookieAccessAllowed)()) return null;

  const result = await (0, _chromeCookies.getGoogleCookies)({
    profile: (0, _geminiWebConfig.normalizeChromeProfile)(chromeProfile) ?? (0, _geminiWebConfig.getChromeProfileFromConfig)(),
